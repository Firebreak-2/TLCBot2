...
public static class TLCLogListener
{
    public static void PreInitialize()
    {
        ...
        // Program.Client.ReactionRemoved += 
        // Program.Client.ReactionsCleared += 
        // Program.Client.ReactionsRemovedForEmote += 
        // Program.Client.RoleCreated += 
        // Program.Client.RoleDeleted += 
        // Program.Client.RoleUpdated += 
        // Program.Client.SpeakerAdded += 
        // Program.Client.SpeakerRemoved += 
        // Program.Client.StageStarted += 
        // Program.Client.StageEnded += 
        // Program.Client.StageUpdated += 
        // Program.Client.ThreadCreated += 
        // Program.Client.ThreadDeleted += 
        // Program.Client.ThreadUpdated += 
        ...
        SocketReaction reaction)
    {
        ...
        return AddLogEntry(LogSignificance.Useless,
            ...
            ("Channel", channel.Name)); // add display for custom reaction emote using image url and casting to Emote
    }
    ...
    public static Task OnPresenceUpdated(
        ...
        AddLogEntry(LogSignificance.Useless,
            new[] {"status changed", "user change"},
            "Status Changed",
            user,
    ...
    {
        if (channel.Id == RuntimeConfig.CommandExecutionLog.Id) return Task.CompletedTask;
        ...
        Cacheable<IMessageChannel, ulong> channelCacheable)
    {
        ...
        streamWriter.Close();
        RuntimeConfig.CommandExecutionLog.SendFileAsync(stream, "Messages", "Messages Deleted");
        ...
        string? imageUrl)
    {
        ...
        RuntimeConfig.CommandExecutionLog.SendMessageAsync(tagPrefix, embed: builder.Build());
        return Task.CompletedTask;
    }
}